...
+--------------+--------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
| SPSS         | [`CODEBOOK`](https://libguides.library.kent.edu/spss/codebooks)                                                                                  | Codebook en SPSS  |
+--------------+--------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
| Stata        | [`codebook`](https://www.stata.com/manuals/dcodebook.pdf)                                                                                        | Codebook en Stata |
+--------------+--------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
| R            | [`view_df()`](https://strengejacke.github.io/sjPlot/reference/view_df.html), [`frq()`](https://strengejacke.github.io/sjmisc/reference/frq.html) | Codebook en R     |
+--------------+--------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+
